...
Start the proxy containers and fetch the public Ngrok URL automatically by using the Python CLI:
...
**Stop the Proxy:**
When you are done, tear down the setup with:
```bash
...
Run end-to-end validation to ensure the proxy is correctly communicating with your local Ollama model:
